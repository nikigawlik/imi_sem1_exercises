...
{   
    ...
    private void prepare() 
    {
        ...
        addObject(tree11, 7, 2);
        Tree tree12 = new Tree();
        addObject(tree12, 6, 2);
        Tree tree13 = new Tree();
        addObject(tree13, 5, 2);
        Tree tree14 = new Tree();
        addObject(tree14, 4, 2);
        Tree tree15 = new Tree();
        addObject(tree15, 3, 2);
        Tree tree16 = new Tree();
        addObject(tree16, 3, 0);
        Tree tree17 = new Tree();
        addObject(tree17, 4, 0);
        Tree tree18 = new Tree();
        addObject(tree18, 5, 0);
        Tree tree19 = new Tree();
        addObject(tree19, 6, 0);
        Tree tree20 = new Tree();
        addObject(tree20, 7, 0);
        MyKara mykara2 = new MyKara();
        addObject(mykara2, 0, 1);
    }
}
