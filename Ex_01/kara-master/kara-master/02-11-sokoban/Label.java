...
public class Label extends Actor
{
    ...
    private Font font = getImage().getFont();
    ...
    /**
     * Sets the alignement of the text and icon.
    ...
    protected GreenfootImage paintTextAndIcon()
    {
        ...
        switch (align)
        {
            ...
            case ALIGN_CENTER:
            textX = (width - fm.charsWidth((getText()).toCharArray(), 0, (getText()).length())) / 2;
            if (iconVisible && icon != null)
            {
            ...
            case ALIGN_RIGHT:
            textX = (width - fm.charsWidth((getText()).toCharArray(), 0, (getText()).length())) - inset;
            if (iconVisible && icon != null)
            {
        ...
        int textY = (height / 2 - 1) - ((fm.getAscent() + fm.getDescent()) / 2) + fm.getAscent();
        int iconY = 0;
        if (iconVisible && icon != null)
        {
