...
public class AnimatedLabel extends Label
{
     ...
     */
    public AnimatedLabel(String text, int width, int height, Font font, int direction)
    {
     ...
     */
    public AnimatedLabel(int width, int height, GreenfootImage icon, int direction)
    {
    ...
    /**
     * Override this method to save the original image and to prevent the Label to
     * set the image too early.
     */
