...
public class HighscoreState extends ScreenState 
{
    ...
    public void initScreen()
    {
        ...
        Label highscoreTitleLabel = new Label("Highscore Level " + currentHighscoreLevel, 500, 70, GameScreen.FONT_XL);
        ...
        GreenfootImage levelImg = gameScreen.getLevel(currentHighscoreLevel).toImage();
        int width = 400;
        int height = 400;
        ...
        gameScreen.addObject(highscoreLevelLabel, GameScreen.WIDTH_IN_CELLS / 2, GameScreen.HEIGHT_IN_CELLS / 2);
        ...
        if (gameScreen.isHighscoreAvailable())
        {
            ...
            Label highscoreSilverLabel = new Label(second, 400, 40, GameScreen.FONT_L);
        ...
        else
        {
            ...
            Label highscoreNa1 = new Label("Highscore is not available!", 400, 40, GameScreen.FONT_XL);
