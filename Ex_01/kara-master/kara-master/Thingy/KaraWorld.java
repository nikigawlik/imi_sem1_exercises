...
{   
    private static final int WORLD_WIDTH = 100;  // Number of horizontal cells
    private static final int WORLD_HEIGHT = 100;  // Number of vertical cells

    private static final int CELL_SIZE = 21; // Size of one cell
